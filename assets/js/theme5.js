(function($) {
    ...
    $window.on("load", function() {
        ...
        if(typeof ST.featureProduct.init === "function") ST.featureProduct.init();
    ...
    ST.categorySlider = {
        init: function() {
            function adjustArrowPosition() {
                var $slideHeight = $(".cat-wrap .cat-slider"),
    ...
    ST.blogSlider = {
        init: function() {
            function adjustArrowPosition() {
                var $slideHeight = $(".blog-wrap .blog-slider .blog-main-img"),
