(function($) {
    ...
    $window.on("load", function() {
        ...
        ST.init();
        if(typeof ST.animateTemplate.init === "function") ST.animateTemplate.init();
        if(typeof ST.mainSlider.init === "function") ST.mainSlider.init();
        if(typeof ST.categorySlider.init === "function") ST.categorySlider.init();
        if(typeof ST.trendProduct.init === "function") ST.trendProduct.init();
        if(typeof ST.testimonialSlider.init === "function") ST.testimonialSlider.init();
        if(typeof ST.brandSlider.init === "function") ST.brandSlider.init();
        if(typeof ST.blogSlider.init === "function") ST.blogSlider.init();
    });
    // Core ST object
    var ST = {
        init: function() {
        ...
        shopContent: function() {
            ...
            $document.on("click", "button.shop-view-btn", function() {
                ...
                $shopProductWrap.removeClass("data-grid data-list").addClass("data-" + $dataView);
        ...
        productReview: function() {
            $(".product-review").each(function() {
                ...
                $document.on("click", ".review-submit", function() {
                        ...
                        <div class="product-review-detail">
                            <div class="row">
                                <div class="col-12 col-md-4 col-xl-3">
                                    <div class="product-reviewer-info d-flex flex-wrap">
                                        ...
                                        <div class="width-calc-48 d-flex flex-column justify-content-center psl-15">
                                            <div class="product-reviewer-name heading-color heading-weight">${reviewName}</div>
                                            <div class="product-reviewer-date mst-6">Reviwed on ${currentDate}</div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-12 col-md-8 col-xl-9">
                                    <div class="product-review-love mst-15 mst-md-0">
                    ...
                    $(".product-review-comment .row.product-review-comment-row").prepend(newReviewDetail);
        ...
        footerJs: function() {
            function adjustArrowPosition() {
                var $slideHeight = $(".insta-wrap .insta-slider"),
    ...
    ST.categorySlider = {
        init: function() {
            function adjustArrowPosition() {
                var $slideHeight = $(".cat-wrap .swiper-slide .cat-block a.cat-img"),
    ...
    ST.testimonialSlider = {
        init: function() {
            function adjustArrowPosition() {
                var $slideHeight = $(".testi-wrap .testi-slider"),
